  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fit fixed max-md:bottom-6 md:top-6 inset-x-0 mx-auto rounded-full bg-transparent/15 z-[5000] pr-2 pl-8 py-2 items-center justify-center space-x-4",
          className
        )}
      >
